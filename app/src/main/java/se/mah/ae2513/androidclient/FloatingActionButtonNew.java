...
public class FloatingActionButtonNew extends FrameLayout {
     ...
     * @param contentParams
     */
    public FloatingActionButtonNew(Context context, ViewGroup.LayoutParams layoutParams, int theme,
    ...
    public static class Builder {
        ...
        public FloatingActionButtonNew build() {
            return new FloatingActionButtonNew(context,
                    layoutParams,
                    theme,
                    backgroundDrawable,
                    position,
